...
IF NOT EXIST recovery.img (
    ...
    echo Please run '1_OneClick_Build.bat' first and download the compiled
    echo recovery.img from your GitHub Actions before running this.
    echo.
    pause
    exit
)
...
echo.
echo [SUCCESS] recovery.tar has been created!
echo.
echo ---------------------------------------------------
